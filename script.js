    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function buildPlanCalc(cur) {
            return ''
                ...
                +   '<div style="background:#e8faed; border:1px solid #d1f4e0; border-radius:6px; padding:10px 12px; display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:8px;">'
                +     '<div style="display:flex; flex-direction:column; gap:2px;">'
                +       '<span style="font-size:0.85rem; font-weight:600; color:var(--navy);">Billed <span class="calc-billed-freq">Annually</span></span>'
                +       '<div class="calc-savings-row" style="align-items:center; gap:4px; font-size:0.75rem; font-weight:700; color:#10b981; display:none;"><svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>Save ' + cur + '<span class="calc-savings">0</span>/yr</span></div>'
                +     '</div>'
                +     '<div style="display:flex; align-items:baseline; gap:6px; text-align:right;">'
                +       '<span style="font-size:0.75rem; font-weight:600; color:#8a94a6;">(' + cur + '<span class="calc-billed-base">0</span> + 18% GST)</span>'
                +       '<span style="font-weight:800; font-size:1.15rem; color:#149b82;">' + cur + '<span class="calc-billed">0</span></span>'
                +     '</div>'
                +   '</div>'
                + '</div>';
        }
